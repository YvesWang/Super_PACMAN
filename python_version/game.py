...
class Game:
  ...
  def __init__( self, agents, display, rules, startingIndex=0, muteAgents=False, catchExceptions=True ):
    ...
    self.catchExceptions = True#catchExceptions
    self.moveHistory = []
  ...
  def run( self ):
    ...
    print('self.totalAgentTimes[0]: {}'.format(float(self.totalAgentTimes[0]*10000)/float(total_step/3)))
    print('self.totalAgentTimes[1]: {}'.format(float(self.totalAgentTimes[1]*10000)/float(total_step/3)))
    print('self.totalAgentTimes[2]: {}'.format(float(self.totalAgentTimes[2]*10000)/float(total_step/3)))

    end_time = time.time()
    print('*************************************')
    print('total_step: {}, total_time: {}, average_time is {}'.format(total_step, end_time-current_time, (end_time-current_time)/total_step))
