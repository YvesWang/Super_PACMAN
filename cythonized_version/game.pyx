...
class Game:
  ...
  def run( self ):
    ...
    print('self.totalAgentTimes[0]: {}'.format((self.totalAgentTimes[0]*10000)/(total_step/3)))
    print('self.totalAgentTimes[1]: {}'.format((self.totalAgentTimes[1]*10000)/(total_step/3)))
    print('self.totalAgentTimes[2]: {}'.format((self.totalAgentTimes[2]*10000)/(total_step/3)))
